...
if (!$fatal)
{
	...
	try
	{
		...
		$facebook->api_client->admin_setAppProperties(array(
			...
			'callback_url'			=> MM_URL.$directory.'/?id=' . $_SESSION['edited_id'],
			'use_iframe'			=> false,
			'desktop'				=> 0,
			'publish_url'			=> MM_URL.$directory.'/publish.php?id=' . $_SESSION['edited_id'],
			'publish_self_url'		=> MM_URL.$directory.'/publish_self.php?id=' . $_SESSION['edited_id']
		));
	}
